 ...
 *             site_name?: scalar|null|Param, // The name which should be displayed for the overall site. // Default: "IDMarinas Seo Bundle"
 *             type?: "website"|"article"|"book"|"profile"|"music.song"|"music.album"|"music.playlist"|"music.radio_station"|"video.movie"|"video.episode"|"video.tv_show"|"video.other"|Param, // The default type of your object as defined by [Open Graph protocol](https://ogp.me/#types). // Default: "website"
 *         },
 *         twitter?: array{ // Default configuration for Twitter Card tags.
 *             card?: "summary"|"summary_large_image"|"app"|"player"|Param, // The type of card to display. // Default: "summary"
 *             site?: scalar|null|Param, // The Twitter site name. It must start with "@". // Default: ""
