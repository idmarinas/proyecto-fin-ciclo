...
- A User Bundle to manage user basics, comes with a password reset and email verification system. [IDMarinas User Bundle]
- Provides tools for SEO optimization in Symfony applications and sitemap generation/management. [IDMarinas SEO Bundle]
- Settings system for Symfony applications. Can be used with User entity or any other. [IDMarinas Settings Bundle]
...
- Talk to an OAuth2 server for social functionality in Symfony. [KnpUOAuth2ClientBundle]
...
[IDMarinas User Bundle]: https://github.com/idmarinas/user-bundle
[IDMarinas SEO Bundle]: https://github.com/idmarinas/seo-bundle
[IDMarinas Settings Bundle]: https://github.com/idmarinas/settings-bundle
